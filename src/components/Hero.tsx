  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/05de9440-60fb-45eb-9411-2eb1810d19cc/bucket/f24da889-e33f-48aa-8f10-a86e498a156d.jpg"
          alt="Аэропорт Хабаровск Новый"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Международный аэропорт"}</p>
          ...
          >
            {"Хабаровск"}
            <br />
            <span className="text-orange-200">{"Новый"}</span>
          </h1>
        </div>
      </div>
